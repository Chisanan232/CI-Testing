from ci_testing.persistence.interface import BasePersistence
from ci_testing.persistence.database.strategy import BaseDatabaseConnection as _BaseDataBaseConnection
